...
A static browser tester is available in `web-test-app/` for Windows laptops. Start the backend, then run:
...
Open `http://localhost:8080` in Chrome or Edge to upload or record a 10-second video and send it to `/api/v1/attendance/preview`.
